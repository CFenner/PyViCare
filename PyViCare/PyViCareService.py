...
def buildSetPropertyUrl(accessor: ViCareDeviceAccessor, property_name: str, action: str) -> str:
...
class ViCareService:
    ...
    def getProperty(self, accessor: ViCareDeviceAccessor, property_name: str) -> Any:
        return self.oauth_manager.get(self.buildGetPropertyUrl(accessor, property_name))

    def buildGetPropertyUrl(self, accessor: ViCareDeviceAccessor, property_name: str) -> str:
        if self._isGateway():
